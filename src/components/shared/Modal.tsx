...
function Modal({ title, closeModal, children }: Props) {
    return (
        <div className="bg-opacity-55 bg-black overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50  flex justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
